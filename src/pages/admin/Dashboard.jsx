  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        <DashboardCard title="Total Students" value="6472" />
        <DashboardCard title="Total Staff" value="50" />
        <DashboardCard title="Faculties" value="12" />
        <DashboardCard title="Departments" value="48" />
        <DashboardCard title="Approved" value="4681" />
        <DashboardCard title="Pending" value="1791" />

        {/* Action cards */}
        <DashboardCard title="Add New Faculty Clearance" isAction />
